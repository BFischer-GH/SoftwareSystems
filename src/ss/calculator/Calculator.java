...
public interface Calculator {
    ...
    /**
     * Add the “dup” operation that duplicates the value on
     * top of the stack: for example, if the value on top of the stack is 123, push another 123 on top of the stack.
     *
     */
    void dup() throws StackEmptyException;

    /**
     * Add the “mod” operation that computes the remainder after division.
     */
