...
import ss.calculator.myCalculator.MyCalculatorFactory;
...
class CalculatorMyMainServer73Test {
    ...
    static void setup() {
        ...
        factory = new MyCalculatorFactory(); // FIXME replace with the actual factory => Done
    }
     ...
     */
    @Test
    void testNetworked() throws IOException, InterruptedException {
